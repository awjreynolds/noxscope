...
The first compelling release line includes:

- versioned canonical Runtime Sessions, capabilities, records, and typed errors;
- Core ordering, immutable views, deny-by-default sanitisation, and bounded
...
No wallet is claimed as fully qualified until the conformance matrix records
exact build, Adapter, suite, and localnet/Preprod evidence.
